...
public class ShizhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShizhuEntity user = shizhuService.selectOne(new EntityWrapper<ShizhuEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody ShizhuEntity shizhu){
    	...
    	ShizhuEntity user = shizhuService.selectOne(new EntityWrapper<ShizhuEntity>().eq("yonghuming", shizhu.getYonghuming()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShizhuEntity shizhu, 
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShizhuEntity shizhu, 
		HttpServletRequest request){
        EntityWrapper<ShizhuEntity> ew = new EntityWrapper<ShizhuEntity>();
		PageUtils page = shizhuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shizhu), params), params));
        return R.ok().put("data", page);
