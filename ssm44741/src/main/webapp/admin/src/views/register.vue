  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(106, 0, 138, 0.47);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 247, 247, 1);fontSize:28px;">高校寻物平台小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='shizhu'" class="input-group">
			   <div class="label">用户名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuming" class="input" type="text" placeholder="用户名">
			   </div>
			 </div> -->
			<el-form-item label="用户名" class="input" v-if="tableName=='shizhu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='shizhu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='shizhu'" class="input-group">
			   <div class="label">失主姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shizhuxingming" class="input" type="text" placeholder="失主姓名">
			   </div>
			 </div> -->
			<el-form-item label="失主姓名" class="input" v-if="tableName=='shizhu'">
			  <el-input v-model="ruleForm.shizhuxingming" autocomplete="off" placeholder="失主姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shizhu'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='shizhu'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shizhu'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='shizhu'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='shizhu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
