  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.shizhuxingming!=''&&json.shizhuxingming){
              		this.ruleForm.shizhuxingming = json.shizhuxingming
		}
        } else {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shizhutousu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shizhutousuCrossAddOrUpdateFlag = false;
                  this.parent.search();
